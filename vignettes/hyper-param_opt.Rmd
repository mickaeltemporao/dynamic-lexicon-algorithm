...
En ayant fixé le nombre de sample à 10, on remarque que la meilleure taille de vecteur à choisir est celle de 20% de la taille du dfm ( 10 ici pour nous ), car c'est celle avec la meilleure moyenne de score et la variation la plus petite. En effet la taille 15 donne un meilleure score mais une variation et une durée d'algorithme plus grande. 
...
On remarque que la meilleure moyenne de score est atteinte lorsque 4 sample sont faits, de plus la variation des scores est tres petites et la durée également.
