...
Pour cela, au lieu de trier le vecteur de calibration en ammant chercher et piocher dans tout le reste disponible, nous allons uniquement aller piocher dans un sous ensemble disponible.

Cela va donc diviser la taille de ma boucle et par conséquent la durée de l'algorithme.
...
On diminue la taille du vecteur restant en ne prenant que 40% de la taille original pour améliorer la rapidité :
...
Les données sont enregistrées dans data_cor3_opti :
...
Cet algorithme tourne en moins de temps que l'algorithme 3 et demeure êter quasi tout aussi performant, les résultats de score sont presque aussi élevés.
