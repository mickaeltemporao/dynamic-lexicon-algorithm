...
```{r}
setwd("C:/Users/fredo/Documents/Code Projet/vigilant-octo-invention")
load("~/Code Projet/vigilant-octo-invention/optimisation_workspace.RData")
...
data_cor3_opti <- arrange(data_cor3_opti,desc(data_cor3$score))
...
data_cor3_opti<-data_cor3_opti[1:8,]
data_cor3_opti
```
...
co<-ggplot(data_cor3,aes(x =seq(1:10), y = abs(score))) +geom_line()+geom_point()
