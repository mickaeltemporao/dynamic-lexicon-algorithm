...
Comme l'algorithme, on commence par récupérer le meilleurs subset retourné de la fonction algo_10 :
...
On fait un sample de taille 40% du vecteur que nous voulons remplacer pour améliorer la rapidité :
